...
| `truck_upgrade` | 트럭 업그레이드 | 새 메뉴 해금 + 모든 메뉴 가격 배율 증가 | 트럭 외관 + 메뉴판 |
...
| 순서 | 파일 | 설명 |
|------|------|------|
| 1-1 | `Menu/MenuData.cs` | 메뉴 ScriptableObject (이름, 기본가격, 아이콘) |
| 1-2 | `Menu/IMenuProvider.cs` | 메뉴 조회 인터페이스 |
| 1-3 | `Menu/MenuManager.cs` | 메뉴 관리, 랜덤 메뉴 선택, 가격 배율 적용 |
